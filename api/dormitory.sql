...
--
-- Host: localhost:3306
-- Generation Time: Feb 08, 2021 at 04:20 PM
...
('2801', '600', '01/2021', '2021-01-25 03:19:53', 'admin1', '600', '2000', '4800', '0', '2800', 1, '2801/1', '2021-01-25 04:12:09', '0');
...
--
-- Table structure for table `qa_student`
--

CREATE TABLE `qa_student` (
  `id` int(11) NOT NULL,
...
--
-- Dumping data for table `qa_student`
--
...
CREATE TABLE `room_history` (
  `no_room_history` int(6) NOT NULL,
...
CREATE TABLE `room_student` (
  `stay_number` int(4) NOT NULL COMMENT 'รหัสการเข้าพัก',
  `std_code` varchar(15) NOT NULL COMMENT 'รหัสนักศึกษา',
...
CREATE TABLE `rules` (
  `rules_number` int(2) NOT NULL COMMENT 'รหัสกฏระเบียบ',
...
--
-- Table structure for table `rules_student`
--

CREATE TABLE `rules_student` (
  `rules_no` int(12) NOT NULL COMMENT 'ลำดับที่',
...
--
-- Dumping data for table `rules_student`
--

INSERT INTO `rules_student` (`rules_no`, `std_code`, `id_card_code`, `date_rule`, `time_rule`, `rules_break`, `other`, `details`) VALUES
(119, '60172110500-8', NULL, '2020-10-28', '01:36', 5, '', ''),
(120, '60172110500-8', NULL, '2020-09-17', '13:00', 10, '', ''),
(121, '60172110500-8', NULL, '2020-10-21', '13:02', 15, '', ''),
(122, '60172110500-8', NULL, '2020-11-25', '13:02', 2, '', ''),
(123, '60172110500-8', NULL, '2020-08-21', '13:02', 8, '', ''),
(130, '60172110502-8', NULL, '2020-10-01', '13:10', 1, '', ''),
(131, '60172110502-8', NULL, '2020-10-23', '13:12', 1, '', ''),
(132, '60172110502-8', NULL, '2020-09-22', '13:12', 9, '', ''),
(133, '60172110502-8', NULL, '2020-08-13', '13:13', 11, '', ''),
(134, '60172110502-8', NULL, '2020-12-15', '13:13', 7, '', ''),
(135, '60172110502-8', NULL, '2020-09-18', '13:13', 7, '', ''),
(136, NULL, '1301801201671', '2020-09-23', '13:18', 1, '', '');
...
CREATE TABLE `std_status` (
  `noStatus` int(2) NOT NULL COMMENT 'รหัสสถานะ',
...
('60152110030-1', 'นางสาว', 'พรสุดา', 'ดีสำโรง', 001, '60241A', '', 1, ''),
...
--
-- Table structure for table `student_cost`
--
...
--
-- Dumping data for table `student_cost`
--
...
('0858656272', NULL, '0', '500', '0', '0', '1', '2020-09-21 11:09:25', 'admin2'),
('11068', NULL, '0', '500', '0', '0', '1', '2020-09-28 00:54:58', 'admin2'),
('11088', NULL, '0', '500', '0', '0', '1', '2020-10-04 23:44:06', 'admin2'),
('1213969025', '60172110559-7', '5500', '0', '0', '0', '1', '2020-08-31 02:08:15', 'admin2'),
('1234434', NULL, '5900', '500', '0', '0', '2', '2020-10-04 20:06:44', 'admin1'),
('12345678', NULL, '50', '0', '0', '0', '2', '2020-09-27 22:37:23', 'admin1'),
('12345678', NULL, '10', '0', '0', '0', '2', '2020-09-27 22:43:05', 'admin1'),
('3037097961', NULL, '0', '500', '0', '0', '1', '2020-09-21 06:49:43', 'admin1'),
('3102030590', '60162110523-6', '5000', '1000', '0', '0', '1', '2020-09-02 04:18:26', 'admin2'),
('3122667740', NULL, '3500', '1000', '0', '400', '1', '2020-09-20 18:31:20', 'admin2'),
('3126819948', NULL, '0', '1000', '0', '0', '1', '2020-09-22 09:50:01', 'admin2'),
('4192722283', NULL, '500', '0', '450', '100', '1', '2020-09-20 18:40:24', 'admin2'),
('5247233907', NULL, '6000', '0', '0', '500', '1', '2020-09-21 07:12:22', 'admin1'),
('7362779303', NULL, '0', '0', '50', '0', '1', '2020-08-30 22:49:54', 'admin1'),
('7422032733', '60162110523-6', '700', '0', '0', '0', '1', '2020-09-02 04:18:48', 'admin2'),
('8012778298', NULL, '2000', '0', '0', '0', '1', '2020-08-30 22:49:44', 'admin1'),
('8742017679', '60162110524-6', '4000', '0', '0', '0', '1', '2020-09-02 04:16:18', 'admin2'),
('9383972343', '60172110559-7', '0', '800', '0', '0', '1', '2020-08-31 02:08:45', 'admin2');
...
CREATE TABLE `time` (
  `time_number` int(12) NOT NULL COMMENT 'รหัสเวลา',
  `std_code` varchar(15) NOT NULL COMMENT 'รหัสนักศึกษา',
...
(12, '60172110142-4', '2020-07-18', '23:43', 1),
(13, '60172110142-4', '2020-08-21', '23:44', 1),
(14, '60172110142-4', '2020-09-22', '23:43', 1),
(15, '60172110142-4', '2020-10-27', '15:31', 0),
(17, '60152110353-3', '2020-08-23', '23:43', 1),
(18, '60152110353-3', '2020-08-26', '22:19', 0),
(19, '60152110353-3', '2020-09-27', '23:43', 1),
(20, '60152110053-6', '2020-10-27', '22:19', 0),
(21, '60172110142-4', '2020-11-20', '22:19', 0),
(22, '60152110053-6', '2020-07-22', '22:19', 0),
(24, '60152110053-6', '2020-08-23', '22:19', 0),
(25, '60152110053-6', '2020-08-24', '22:19', 0),
(26, '60152110053-6', '2020-08-25', '22:19', 0),
(27, '60152110053-6', '2020-08-26', '03:19', 1),
(29, '60152110053-6', '2020-09-28', '22:19', 0),
(30, '60152110053-6', '2020-09-29', '22:19', 0),
(31, '62162110020-7', '2020-07-11', '22:20', 0),
(32, '62162110020-7', '2020-07-12', '01:12', 1),
(33, '62162110020-7', '2020-07-13', '22:20', 0),
(34, '62162110020-7', '2020-08-15', '22:20', 0),
(35, '62162110020-7', '2020-08-20', '01:12', 1),
(36, '62162110020-7', '2020-08-21', '22:20', 0),
(37, '62162110020-7', '2020-09-22', '22:20', 0),
(38, '62162110020-7', '2020-09-24', '01:20', 1),
(39, '62162110020-7', '2020-07-19', '22:20', 0),
(40, '60162110001-5', '2020-07-27', '22:24', 0),
(41, '60162110001-5', '2020-08-19', '22:24', 0),
(42, '60162110001-5', '2020-08-22', '22:25', 0),
(43, '60162110001-5', '2020-08-27', '22:25', 0),
(44, '60162110001-5', '2020-09-19', '22:25', 0),
(45, '60162110001-5', '2020-09-20', '22:25', 0),
(46, '60162110001-5', '2020-09-27', '22:25', 0),
(47, '60162110001-5', '2020-10-14', '22:25', 0),
(48, '60162110001-5', '2020-10-15', '01:25', 1),
(49, '60162110001-5', '2020-10-24', '02:25', 1),
(50, '63172310162-9', '2020-10-27', '23:18', 1),
(51, '63172110204-5', '2020-10-27', '23:20', 1),
(52, '63172110193-7', '2020-10-27', '23:20', 1),
(53, '63172110191-7', '2020-10-27', '23:20', 1),
(54, '63182110057-4', '2020-10-27', '23:21', 1),
(55, '63171110322-1', '2020-10-27', '23:23', 1),
(56, '63172310467-6', '2020-10-27', '23:25', 1),
(57, '63172310040-5', '2020-10-27', '23:25', 1),
(58, '63172310165-9', '2020-10-27', '23:25', 1),
(59, '63172310248-3', '2020-10-27', '23:25', 1),
(60, '63172110239-9', '2020-10-27', '23:27', 1),
(61, '63162110092-0', '2020-10-27', '23:28', 1),
(62, '63152110213-7', '2020-10-27', '23:28', 1),
(63, '63182110202-3', '2020-10-27', '23:28', 1),
(64, '63171110220-2', '2020-10-27', '23:28', 1),
(65, '63171110196-8', '2020-10-27', '23:29', 1),
(66, '63171110204-6', '2020-10-27', '23:29', 1),
(67, '63182110190-5', '2020-10-27', '23:30', 1),
(68, '63182110175-9', '2020-10-27', '23:31', 1),
(69, '63152110099-2', '2020-10-27', '23:31', 1),
(70, '63171110048-0', '2020-10-27', '23:33', 1),
(71, '63171110054-7', '2020-10-27', '23:33', 1),
(72, '63172110170-1', '2020-10-27', '23:33', 1),
(73, '63182110230-7', '2020-10-27', '23:36', 1),
(74, '63172110435-7', '2020-10-27', '23:36', 1),
(75, '63172310355-9', '2020-10-27', '23:37', 1),
(76, '63182110034-9', '2020-10-27', '23:37', 1),
(77, '63172110420-9', '2020-10-27', '23:41', 1),
(78, '63162110250-6', '2020-10-27', '23:41', 1),
(79, '63162110282-0', '2020-10-27', '23:42', 1),
(80, '63172310138-6', '2020-10-27', '23:43', 1),
(81, '63172110184-9', '2020-10-27', '23:44', 1),
(82, '63172310183-5', '2020-10-27', '23:44', 1),
(83, '63162110267-4', '2020-10-27', '23:45', 1),
(84, '63172310438-3', '2020-10-27', '23:47', 1),
(85, '63172310116-0', '2020-10-27', '23:47', 1),
(86, '61172110416-5', '2020-10-27', '23:47', 1),
(87, '60172110142-4', '2020-10-27', '23:55', 1),
(88, '63152110436-1', '2020-10-27', '23:56', 1),
(89, '63172110427-9', '2020-10-27', '23:57', 1),
(90, '63172310273-6', '2020-10-27', '23:57', 1),
(91, '63172310272-6', '2020-10-27', '23:58', 1),
(92, '63172310323-6', '2020-10-27', '23:58', 1),
(93, '63172110176-1', '2020-10-28', '00:00', 1),
(94, '63172110348-6', '2020-10-28', '00:00', 1),
(95, '63172110177-1', '2020-10-28', '00:02', 1),
(96, '63172110339-8', '2020-10-28', '00:03', 1),
(97, '63172110295-6', '2020-10-28', '00:03', 1),
(98, '63172110536-6', '2020-10-28', '00:04', 1),
(99, '63171110279-1', '2020-10-28', '00:06', 1),
(100, '63172110092-8', '2020-10-28', '00:09', 1),
(101, '63172110413-1', '2020-10-28', '00:13', 1),
(102, '63172110253-4', '2020-10-28', '00:13', 1),
(103, '63171110137-1', '2020-10-28', '00:15', 1),
(104, '63171110028-4', '2020-10-28', '00:16', 1),
(105, '63172310106-2', '2020-10-28', '00:19', 1),
(111, '60172110142-4', '2020-11-03', '17:02', 0),
(112, '60172110142-4', '2020-11-03', '17:03', 0),
(113, '60172110142-4', '2020-11-05', '18:25', 0),
(114, '60172110142-4', '2020-11-26', '17:01', 0);
...
CREATE TABLE `time_set` (
  `noTime` int(11) NOT NULL COMMENT 'ลำดับ',
...
ALTER TABLE `branch`
  ...
  ADD KEY `faculty_codeFK` (`faculty_code`),
  ADD KEY `FK_levels` (`levels`);

--
-- Indexes for table `cost_value`
--
...
ALTER TABLE `electric_bill`
  ADD PRIMARY KEY (`room_number`,`month_read`),
  ADD KEY `FK_electric_bill_user` (`user_edit`);
...
--
ALTER TABLE `level`
  ADD PRIMARY KEY (`noLevel`);

--
-- Indexes for table `outsider`
--
ALTER TABLE `outsider`
  ADD PRIMARY KEY (`id_card_code`,`std_code`),
  ADD KEY `FK_std_codes` (`std_code`);

--
-- Indexes for table `qa_student`
--
ALTER TABLE `qa_student`
  ADD PRIMARY KEY (`id`),
  ADD KEY `FK_qa_student_student` (`student`),
  ADD KEY `FK_qa_student_user` (`admin`);
...
ALTER TABLE `room_history`
  ADD PRIMARY KEY (`no_room_history`),
  ADD KEY `FK_status` (`status`),
  ADD KEY `FK_std_code1` (`std_code`);

--
-- Indexes for table `room_status`
--
ALTER TABLE `room_status`
  ADD PRIMARY KEY (`status_number`);
...
ALTER TABLE `room_student`
  ...
  ADD KEY `room_student_ibfk_1` (`room_number`),
  ADD KEY `room_student_ibfk_2` (`std_code`);

--
-- Indexes for table `rules`
--
ALTER TABLE `rules`
  ADD PRIMARY KEY (`rules_number`);

--
-- Indexes for table `rules_student`
--
ALTER TABLE `rules_student`
  ADD PRIMARY KEY (`rules_no`),
  ADD KEY `FK_rules_number` (`rules_break`),
  ADD KEY `FK_id_card` (`id_card_code`),
  ADD KEY `FK_std_number` (`std_code`);

--
-- Indexes for table `std_status`
--
ALTER TABLE `std_status`
  ADD PRIMARY KEY (`noStatus`);
...
ALTER TABLE `student`
  ...
  ADD KEY `std_statusFK` (`status`),
  ADD KEY `branch_codeFK` (`branch_code`);

--
-- Indexes for table `student_cost`
--
ALTER TABLE `student_cost`
  ADD PRIMARY KEY (`receiptNumber`,`update_time`),
  ADD KEY `FK__student` (`studentId`),
  ADD KEY `FK__user` (`cashier`);

--
-- Indexes for table `time`
--
ALTER TABLE `time`
  ADD PRIMARY KEY (`time_number`),
  ADD KEY `FK_std_code` (`std_code`);

--
-- Indexes for table `time_set`
--
ALTER TABLE `time_set`
  ADD PRIMARY KEY (`noTime`);
...
ALTER TABLE `user`
  ...
  ADD KEY `FK_user_admin_type` (`type`);
...
--
ALTER TABLE `branch`
  MODIFY `branch_code` int(3) UNSIGNED ZEROFILL NOT NULL AUTO_INCREMENT COMMENT 'รหัสสาขา', AUTO_INCREMENT=165;

--
-- AUTO_INCREMENT for table `cost_value`
--
ALTER TABLE `cost_value`
...
--
ALTER TABLE `level`
  MODIFY `noLevel` int(4) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT for table `qa_student`
--
ALTER TABLE `qa_student`
...
--
ALTER TABLE `room_history`
  MODIFY `no_room_history` int(6) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `room_status`
--
ALTER TABLE `room_status`
  MODIFY `status_number` int(2) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT for table `room_student`
--
ALTER TABLE `room_student`
  MODIFY `stay_number` int(4) NOT NULL AUTO_INCREMENT COMMENT 'รหัสการเข้าพัก', AUTO_INCREMENT=2901;

--
-- AUTO_INCREMENT for table `rules`
--
ALTER TABLE `rules`
  MODIFY `rules_number` int(2) NOT NULL AUTO_INCREMENT COMMENT 'รหัสกฏระเบียบ', AUTO_INCREMENT=17;

--
-- AUTO_INCREMENT for table `rules_student`
--
ALTER TABLE `rules_student`
  MODIFY `rules_no` int(12) NOT NULL AUTO_INCREMENT COMMENT 'ลำดับที่', AUTO_INCREMENT=137;

--
-- AUTO_INCREMENT for table `std_status`
--
ALTER TABLE `std_status`
  MODIFY `noStatus` int(2) NOT NULL AUTO_INCREMENT COMMENT 'รหัสสถานะ', AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT for table `time`
--
ALTER TABLE `time`
  MODIFY `time_number` int(12) NOT NULL AUTO_INCREMENT COMMENT 'รหัสเวลา', AUTO_INCREMENT=115;

--
-- AUTO_INCREMENT for table `time_set`
--
ALTER TABLE `time_set`
  MODIFY `noTime` int(11) NOT NULL AUTO_INCREMENT COMMENT 'ลำดับ', AUTO_INCREMENT=3;
...
--
ALTER TABLE `branch`
  ADD CONSTRAINT `FK_levels` FOREIGN KEY (`levels`) REFERENCES `level` (`noLevel`) ON DELETE NO ACTION ON UPDATE CASCADE,
  ADD CONSTRAINT `faculty_codeFK` FOREIGN KEY (`faculty_code`) REFERENCES `faculty` (`faculty_code`) ON DELETE NO ACTION ON UPDATE CASCADE;

--
-- Constraints for table `electric_bill`
--
ALTER TABLE `electric_bill`
  ADD CONSTRAINT `FK_electric_bill_user` FOREIGN KEY (`user_edit`) REFERENCES `user` (`username`) ON DELETE SET NULL ON UPDATE SET NULL;

--
-- Constraints for table `outsider`
--
ALTER TABLE `outsider`
  ADD CONSTRAINT `FK_std_codes` FOREIGN KEY (`std_code`) REFERENCES `student` (`std_code`) ON DELETE NO ACTION ON UPDATE CASCADE;

--
-- Constraints for table `qa_student`
--
ALTER TABLE `qa_student`
  ADD CONSTRAINT `FK_qa_student_student` FOREIGN KEY (`student`) REFERENCES `student` (`std_code`) ON DELETE SET NULL ON UPDATE SET NULL,
  ADD CONSTRAINT `FK_qa_student_user` FOREIGN KEY (`admin`) REFERENCES `user` (`username`) ON DELETE SET NULL ON UPDATE SET NULL;

--
-- Constraints for table `room_history`
--
ALTER TABLE `room_history`
  ADD CONSTRAINT `FK_status` FOREIGN KEY (`status`) REFERENCES `room_status` (`status_number`) ON DELETE CASCADE ON UPDATE NO ACTION,
  ADD CONSTRAINT `FK_std_code1` FOREIGN KEY (`std_code`) REFERENCES `student` (`std_code`);

--
-- Constraints for table `room_student`
--
ALTER TABLE `room_student`
  ADD CONSTRAINT `room_student_ibfk_1` FOREIGN KEY (`room_number`) REFERENCES `room` (`room_number`) ON DELETE NO ACTION ON UPDATE CASCADE,
  ADD CONSTRAINT `room_student_ibfk_2` FOREIGN KEY (`std_code`) REFERENCES `student` (`std_code`) ON DELETE NO ACTION ON UPDATE CASCADE;

--
-- Constraints for table `rules_student`
--
ALTER TABLE `rules_student`
  ADD CONSTRAINT `FK_id_card` FOREIGN KEY (`id_card_code`) REFERENCES `outsider` (`id_card_code`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `FK_rules_number` FOREIGN KEY (`rules_break`) REFERENCES `rules` (`rules_number`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `FK_std_number` FOREIGN KEY (`std_code`) REFERENCES `student` (`std_code`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `student`
--
ALTER TABLE `student`
  ADD CONSTRAINT `branch_codeFK` FOREIGN KEY (`branch_code`) REFERENCES `branch` (`branch_code`) ON DELETE NO ACTION ON UPDATE CASCADE,
  ADD CONSTRAINT `std_statusFK` FOREIGN KEY (`status`) REFERENCES `std_status` (`noStatus`) ON DELETE NO ACTION ON UPDATE CASCADE;

--
-- Constraints for table `student_cost`
--
ALTER TABLE `student_cost`
  ADD CONSTRAINT `FK__student` FOREIGN KEY (`studentId`) REFERENCES `student` (`std_code`) ON DELETE SET NULL ON UPDATE SET NULL;

--
-- Constraints for table `time`
--
ALTER TABLE `time`
  ADD CONSTRAINT `FK_std_code` FOREIGN KEY (`std_code`) REFERENCES `student` (`std_code`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `user`
--
ALTER TABLE `user`
  ADD CONSTRAINT `FK_user_admin_type` FOREIGN KEY (`type`) REFERENCES `admin_type` (`type_id`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;
